...
from .variblesretrieve import retrieve_sentences_count, retrieve_SentencePerParagraph_count, retrieve_noun_count, \
    ...
    retrieve_paragraph_count, badgecount1, retreive_citations2
...
class ShareKnowledgeSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        """
        print('method call')
        return ShareKnowledge.objects.create(**validated_data)
    ...
    def update(self, instance, validated_data):
        ...
        """
        print('method call')
        if instance.allcitationcnt is not None:
            cl = instance.allcitationcnt + ',' + validated_data.get('allcitationcnt', instance.allcitationcnt)
            print('1234')
        else:
            print('abc')
            cl = validated_data.get('allcitationcnt', instance.allcitationcnt)
        # delete duplicate ids
        #cl = ShareKnowledge.objects.values_list('allcitationcnt', flat=True).delete()
        instance.allcitationcnt = cl
...
class SearchdbSerializer(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        ...
        citations_v = retreive_citations2(instance.name)
        ...
        instance.rank_label = NewRank(1, sentence_count_v, sentensePerpara_v, nouns_v, verbs_v, adverbs_v, adjectives_v,
                                      stopwords_v, badge_v, member_v, citations_v)
